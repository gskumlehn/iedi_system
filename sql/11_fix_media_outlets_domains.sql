...
-- CREATE TABLE iedi.media_outlet_backup AS SELECT * FROM iedi.media_outlet;

-- Corrigir: agenciabrasil.ebc.com.br -> ebc.com.br (23 mentions)
UPDATE iedi.media_outlet
...
-- Contar media_outlet atualizados
SELECT
  'Total de media_outlet' as metric,
  COUNT(*) as value
FROM iedi.media_outlet
UNION ALL
SELECT
